    ...
    <div className="dashboard">
      <nav className="nav-header">
        <div className="container nav-content">
          <h1 className="nav-title">Operator Dashboard</h1>
      ...
      <div className="container dashboard-content">
        <div className="card">
          ...
          <div className="info-grid">
            ...
            <div>
              <p className="info-item-label">Company Name</p>
              <p className="info-item-value">{user?.companyName}</p>
            </div>
            <div>
              <p className="info-item-label">Company Address</p>
              <p className="info-item-value">{user?.companyAddress}</p>
            </div>
          </div>
        </div>
      </div>
